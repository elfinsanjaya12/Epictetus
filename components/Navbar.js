      ...
      <Container>
        <div className='flex items-center'>
          ...
          >
            ...
            <ul className='flex lg:space-x-14 lg:items-center flex-col lg:flex-row space-y-4 lg:space-y-0'>
              <li>
                <Link href='/posts'>
          ...
          <div
            className={`lg:w-3/12 absolute lg:static w-full px-10 lg:px-0 left-0 transition-all ${
